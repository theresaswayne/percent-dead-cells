...
IJ.run("Set Measurements...", "area mean stack limit display redirect=None decimal=3")
...
print "By counting points generated by MaximumFinder(), I found " + str(CountMethod4) + " maxima."
